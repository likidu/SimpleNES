...
namespace sn
{
    void VirtualScreen::create(unsigned int w, unsigned int h, float pixel_size, smk::Color color)
    {
    ...
    void VirtualScreen::setPixel(std::size_t x, std::size_t y, smk::Color color)
    {
        auto index = (x * m_screenSize.y + y) * 6;
